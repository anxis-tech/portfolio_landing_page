...
export function ProjectCard({ project }: ProjectCardProps) {
  return (
    <article className="group bg-[#FFFFFF] border border-[#E7E1DB] rounded-2xl overflow-hidden shadow-xs hover:border-[#C96A4A]/40 transition-all duration-300">
      ...
      <div className="flex items-center justify-between px-4 py-2.5 bg-[#F7F4F0] border-b border-[#E7E1DB]">
        ...
        <div className="flex items-center space-x-2 px-3 py-0.5 rounded-md bg-[#FFFFFF] border border-[#E7E1DB] text-[10px] text-[#73706C] font-mono">
      ...
      <div className="relative w-full aspect-16/10 overflow-hidden bg-[#F7F4F0]">
        <Image
          src={project.image}
          alt={project.title}
          fill
        ...
        />
        <div className="absolute inset-0 bg-[#252525]/0 group-hover:bg-[#252525]/5 transition-colors duration-300" />
      </div>
      ...
      <div className="p-6 sm:p-8 space-y-4">
        ...
        {/* Title */}
        <h3 className="text-2xl sm:text-3xl font-bold tracking-tight text-[#252525] group-hover:text-[#C96A4A] transition-colors duration-200">
          {project.title}
        </h3>

        {/* Description */}
        <p className="text-sm sm:text-base text-[#73706C] leading-relaxed font-normal">
          {project.description}
        </p>
        ...
        {/* Action Links */}
        <div className="pt-4 border-t border-[#E7E1DB] flex flex-wrap items-center gap-4">
          <a
